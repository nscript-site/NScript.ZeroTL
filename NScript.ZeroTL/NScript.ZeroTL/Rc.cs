...
{
    public unsafe struct PinnedRc<T> : IDisposable where T : struct, IDisposable
    {
        unsafe T* _pValue;
        unsafe Int64* _pRc;
    ...
    public ref struct Rcd<T> where T : struct, IDisposable
    {
        unsafe T* _pValue;
        unsafe Int64* _pRc;
    ...
    public ref struct Rc<T> where T : struct
    {
        ...
        public unsafe static implicit operator Rc<T>(T d)
        {
            return new Rc<T>(&d);
        }
